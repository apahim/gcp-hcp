...
* Each regional Gecko instance maintains its own roles and bindings independently — cross-region consistency requires the separate [cross-region resource replication](../infrastructure/cross-region-resource-replication.md) mechanism with eventual consistency guarantees
