...
| [hcp-terraform-workload-identity-federation](automation/hcp-terraform-workload-identity-federation.md) | HCP Terraform WIF via infra-platform module with dedicated access projects per environment |
