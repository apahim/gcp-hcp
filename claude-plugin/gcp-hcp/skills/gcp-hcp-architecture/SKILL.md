...
| **testing** | — | — | [hypershift-repo-gcp-hcp-e2e-tests-implementation](https://github.com/openshift-online/gcp-hcp/blob/main/implementation-plans/hypershift-repo-gcp-hcp-e2e-tests-implementation.md). Docs: [ci-e2e-test-flow](https://github.com/openshift-online/gcp-hcp/blob/main/docs/ci-e2e-test-flow.md), [create-cluster-test-validations](https://github.com/openshift-online/gcp-hcp/blob/main/docs/create-cluster-test-validations.md) |
